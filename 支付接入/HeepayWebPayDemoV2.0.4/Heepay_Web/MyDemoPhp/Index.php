    ...
    <div>
        <table class="tab" width="100%" border="0" align="center">
            ...
            <tr>
                ...
                <td>
                    <input name="agentbillid" type="text" value="<?= substr(md5(rand(0,100000)),0,32) ?>" id="agentbillid" />商户系统内部的定单号（<span style="color: Red;">要保证唯一</span>）
                </td>
            </tr>
            <tr>
                <td align="left">
            ...
            <tr>
                ...
                <td>
                    <input name="goodsname" type="text" value="商品<?= substr(md5(rand(0,100000)),0,4) ?>" id="goodsname" />长度最长50字符
                </td>
            </tr>
            <tr>
                <td align="left" style="width: 150px">
            ...
            <tr>
                ...
                <td>
                    <input name="remark" type="text" value="返回<?= substr(md5(rand(0,100000)),0,4) ?>" id="remark" />
                    商户自定义原样返回,最长50字符
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input name="goods_note" type="text" value="说明<?= substr(md5(rand(0,100000)),0,4) ?>" id="goods_note" />支付说明, 长度50字符
                </td>
            </tr>
            <tr>
                <td align="center" colspan="2">
