...
<body>
    <form name="form1" method="post" action="PostAction.asp" id="form1" target="_blank">
    ...
    <div>
        <table class="tab" width="100%" border="0" align="center">
            ...
            <tr>
                ...
                <td>
                    <input name="agentbillid" type="text" value="<%= left(md5(Cstr((timer*1000) Mod 1000)),15) %>" id="agentbillid" />商户系统内部的定单号（<span style="color: Red;">要保证唯一</span>）
                </td>
            </tr>
            <tr>
                <td align="left">
            ...
            <tr>
                ...
                <td>
                    <input name="goodsname" type="text" value="商品<%= left(md5(Cstr((timer*1000) Mod 1000)),8) %>" id="goodsname" />长度最长50字符
                </td>
            </tr>
            <tr>
                <td align="left" style="width: 150px">
            ...
            <tr>
                ...
                <td>
                    <input name="remark" type="text" value="返回<%= left(md5(Cstr((timer*1000) Mod 1000)),8) %>" id="remark" />
                    商户自定义原样返回,最长50字符
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input name="goods_note" type="text" value="说明<%= left(md5(Cstr((timer*1000) Mod 1000)),8) %>" id="goods_note" />支付说明, 长度50字符
                </td>
            </tr>
            <tr>
                <td align="center" colspan="2">
