...
<%
	...
	merchantSignMsgVal = appendParam(merchantSignMsgVal, "key","Z4Q48K5E57Q25GH3");
	String signMsgVal ="";
	  signMsgVal = MD5Util.md5Hex(merchantSignMsgVal.getBytes("utf-8")).toUpperCase();
...
if(signMsgVal.equalsIgnoreCase(signMsg)){
  		switch(Integer.parseInt(payResult))
  		{
  			case 10:
  					...
  					*/
  					...
  					rtnUrl="http://192.168.121.64:8080/RMBPAY/show.jsp?msg=success";
  					break;
  			default:
  					rtnOK=1;
  					//以下是我们快钱设置的show页面，商户需要自己定义该页面。
  					rtnUrl="http://192.168.121.64:8080/RMBPAY/show.jsp?msg=false";
  					break;
  		}
  	}
  	else
  	{
  		rtnOK=1;
  		//以下是我们快钱设置的show页面，商户需要自己定义该页面。
  		rtnUrl="http://192.168.121.64:8080/RMBPAY/show.jsp?msg=error";
  	}	
   %>
